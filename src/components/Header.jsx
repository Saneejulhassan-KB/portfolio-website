    ...
    return (
        ...
        <>
            <div className="navbar">
                ...
                >
                    <li><img src="https://media.glamourmagazine.co.uk/photos/6138e18bba7d9f71f540312c/master/pass/David-Beckham-Modern-Essent.jpg" alt="" width={'50px'} height={'50px'} style={{ borderRadius: '50%' }} /></li>
                    <hr style={{ width: '100%' }} />
                    <a href="#home">
                        <motion.li
                            whileTap={{ scale: 0.5 }}
